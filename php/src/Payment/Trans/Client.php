...
namespace Alipay\EasySDK\Payment\Trans;
...
use Alipay\EasySDK\Payment\Trans\Models\AlipayFundTransUniTransferResponse;
...
class Client {
    ...
    public function transfer($outTradeNo, $totalAmount, $title, $info, $remark){
        $_runtime = [
        ...
        while (Tea::allowRetry($_runtime["retry"], $_retryTimes, $_now)) {
            ...
            try {
                ...
                $bizParams = [
                    ...
                    "payee_info"   => $info,
                    "remark"       => $remark,
                    'business_params' => json_encode(['sub_biz_scene'=>'REDPACKET'])
                ];
                $textParams = [];
